	 ...
	 <div class="main-wrap">
        ...
        <div class="main-mid">
            ...
            <ul class="main-mid-list">
                <li class="main-mid-list-1"><a href="/catgory1List.do">Headphone</a></li>
                <li class="main-mid-list-2"><a href="/catgory2List.do">Speaker</a></li>
                <li class="main-mid-list-3"><a href="/catgory3List.do">Turntable</a></li>
                <li class="main-mid-list-4"><a href="/catgory4List.do">Walkman</a></li>
            </ul>
        </div>
        <div class="main-bot">
        ...
        <div class="main-help">
        	<h2>무엇을<br>도와드릴까요?</h2>
        	<ul class="main-help-lists">
        		<li class="main-help-list-1">
        			<a href="noticeList.do?reqPage=1">공지사항</a>
        		</li>
        		<li class="main-help-list-2">
        			<a href="map.do">매장안내</a>
        		</li>
        		<li class="main-help-list-3">
        			<a href="faqqnaList.do?reqPage=1&type=faq">FAQ & QNA</a>
        		</li>
        		<li class="main-help-list-4">
        			<a href="photoList.do">사진전</a>
        		</li>
        	</ul> 
        </div>
    </div>
