...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%
    	int totalCount = (Integer)request.getAttribute("prodCount");
...
<body>
	...
	<div class="product-wrap">
        <div class="product-top-headphone">
            <h2 class="product-top-title">헤드폰/이어폰</h2>
            <div class="product-top-category">
                <div class="product-top-1"><a href="/catgory1List.do">헤드폰/이어폰</a></div>
                <div class="product-top-2"><a href="/catgory2List.do">스피커</a></div>
                <div class="product-top-3"><a href="/catgory3List.do">턴테이블</a></div>
                <div class="product-top-4"><a href="/catgory4List.do">워크맨/녹음기</a></div>
            </div>
        </div>
     ...
     <script>
	     ...
	     $(".more-btn").on("click",function(){
		 	 const amount = 6; // 더보기 클릭 시 추가로 가져올 게시물 수
